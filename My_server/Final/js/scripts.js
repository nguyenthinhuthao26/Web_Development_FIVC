(function($){
  ...
  $(document).ready(function () {
    ...
    function handleQuantityChange() {
        ...
        var price = $(this).closest('tr').find('.product-price .amount').text().replace(/[.,]/g, ''); // Replace periods and commas with an empty string
        var subtotal = quantity * parseFloat(price);
        $(this).closest('tr').find('.product-subtotal .amount').text(subtotal.toLocaleString('vi-VN') + ' VND');
        updateTotal();
    }
    ...
    function updateTotal() {
        ...
        $('.product-subtotal .amount').each(function () {
            var subtotal = parseFloat($(this).text().replace(/[.,]/g, '')); // Replace periods and commas with an empty string
            total += subtotal;
        });
        // Display total with a dot as a thousand separator
        $('#total-amount').text(total.toLocaleString('vi-VN') + ' VND');
    }

    // Attach event handlers
    $('.quantity .input-text').on('change', handleQuantityChange);
    ...
    $('.product-remove a').on('click', handleRemoveItem);
